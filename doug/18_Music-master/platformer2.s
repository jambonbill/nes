...
;
	...
	sec
	sbc     _eject_R
L07C0:	sta     _BoxGuy1+1
;
; if(BoxGuy1.vel_y < 0x300){
;
L062C:	lda     _BoxGuy1+6
	cmp     #$00
	lda     _BoxGuy1+6+1
	sbc     #$03
	bvc     L0636
...
;
L06E5:	ldy     _coordinates
	lda     _c_map2,y
L07D6:	sta     _collision
;
