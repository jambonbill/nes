...
#include "BG/buck.h" // backgrounds compressed as rle files
#include "BG/duplexor.h"
...
void main (void) {
	...
	//vram_unrle(N0);// this unpacks a compressed full nametable
	vram_write(duplexor,1024);

	vram_adr(NAMETABLE_C);// this sets a start position on the BG, top left of screen C

	//vram_unrle(N2);// this unpacks a compressed full nametable
