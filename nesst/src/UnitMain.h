...
class TFormMain : public TForm
{
	...
	TMenuItem *N23;
	TMenuItem *MAddOffsetMetaSprites;
	...
	void __fastcall MPutSelectionToMetaspriteSkipZeroClick(TObject *Sender);
	...
	void __fastcall MAddOffsetMetaSpritesClick(TObject *Sender);
